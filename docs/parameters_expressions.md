...
$$\sigma_I^2\left(D_G\right)= 8.70 k^{7 / 6}\times \operatorname{Re} \left\{\int_{0}^L C_n^2(h(z))\left[\left(\frac{k D_G^2}{16}+i z\right)^{5 / 6}-\left(\frac{k D_G^2}{16}\right)^{5 / 6}\right]\, d z\right\}$$
...
$$\theta_0 = \left\{L\left[ 2.91 k^2  (\mu_{1u} + 0.62\mu_{2u}\Lambda^{11/6}) \right]^{3/5}\right\}^{-1}$$
with
$$
\begin{align}
...
$$\sigma_{I,sph}^{2} = \exp \left\{\frac{0.49 \sigma_{B u}^2}{\left[1+ 0.56 \sigma_{B u}^{12 / 5}\right]^{7 / 6}}+\frac{0.51 \sigma_{B u}^2}{\left(1+0.69 \sigma_{B u}^{12 / 5}\right)^{5 / 6}}\right\}-1$$

### `rytov_variance_UL_gaussian`

$$\sigma_{B u}^2 =  8.70 k^{7 / 6}L^{5 / 6} \times \operatorname{Re} \left\{\int_{0}^L C_n^2(h(z))\left[\xi^{5 / 6}[\Lambda \xi+i(1-\bar{\Theta} \xi)]^{5 / 6}-\Lambda^{5 / 6} \xi^{5 / 3}\right]\, dz\right\}$$
where $$\xi= 1-z/L$$
...
$$\begin{aligned}
\sigma_{I, l}^2(0, L)_{\text {untracked }}&=34.29\left(\frac{\Lambda L}{k r_{0T}^2}\right)^{5 / 6}\left(\frac{\sigma_{p e}^2}{W^2}\right)\\&+ \exp \left\{\frac{0.49 \sigma_{B u}^2}{\left[1+(1+\Theta) 0.56 \sigma_{B u}^{12 / 5}\right]^{7 / 6}}+\frac{0.51 \sigma_{B u}^2}{\left(1+0.69 \sigma_{B u}^{12 / 5}\right)^{5 / 6}}\right\}-1 
\end{aligned}$$
...
$$\begin{aligned}
\sigma_{I, l}^2(0, L)_{\text {tracked,TC }}&=34.29\left(\frac{\Lambda_{LT} L}{k r_{0T}^2}\right)^{5 / 6}\left(\frac{\sigma_{p e,TC}^2}{W_{LT}^2}\right)\\&+ \exp \left\{\frac{0.49 \sigma_{B u}^2}{\left[1+(1+\Theta) 0.56 \sigma_{B u}^{12 / 5}\right]^{7 / 6}}+\frac{0.51 \sigma_{B u}^2}{\left(1+0.69 \sigma_{B u}^{12 / 5}\right)^{5 / 6}}\right\}-1 
\end{aligned}$$
where $$W_{LT} = W\left[1 + \left(\frac{2\sqrt{2}W_0}{r_{0T}}\right)^{5/3}\right]^{3/5}$$  (valid only for $H\gg 20$ km )$$\Lambda_{LT} = \frac{2L}{kW_{LT}^2}$$